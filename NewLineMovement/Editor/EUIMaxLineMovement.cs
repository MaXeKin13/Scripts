...
[CustomEditor(typeof(MaxUILineMovement))]
public class EMaxUILineMovement : Editor
{
    private MaxUILineMovement _lineMovement;


    //where buttons are in inspector
    public override void OnInspectorGUI()
    {
        MaxUILineMovement pathMovement = (MaxUILineMovement)target;
        //
        DrawDefaultInspector();
        //Set current position to animation position
        if (GUILayout.Button("Set Point"))
        {
            _lineMovement.PathPoints[_lineMovement.currentPos].position = _lineMovement.trans.anchoredPosition;
    ...
    {
        //TODO: convert point.position to world position
        //Debug.Log("SceneGUI");
        MaxUILineMovement pathMovement = (MaxUILineMovement)target;
    ...
    private void OnEnable()
    {
        ...
        {
            //target is object
            _lineMovement = target as MaxUILineMovement;

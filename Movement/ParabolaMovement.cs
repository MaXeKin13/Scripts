...
public class ParabolaMovement : MonoBehaviour
{
    ...
    public static async void Movement(Transform obj, Transform target, float arcHeight, float speed, float timeToComplete, UnityEvent FinishEvent = null)
    {
    ...
    private IEnumerator ParabolaMove(Transform obj, Transform target, float arcHeight = 1f, float speed = 1f, UnityEvent FinishEvent = null)
    {
